...
use super::nullable::nullable_bc;
use crate::posix::bitcoded::fuse;
use crate::posix::bitcoded::mk_eps_bc;
    ...
    match ri {
        ...
        ARegex::Seq(bs, r1, r2) => {
            if nullable_bc(&r1) {
                ...
                let left_branch = ARegex::Seq(bs, Box::new(d1), r2);
                let right_branch = fuse(&eps_bits, d2);
                ARegex::Alt(vec![], Box::new(left_branch), Box::new(right_branch))
            } else {
                let d1 = deriv_bc(*r1, l);
