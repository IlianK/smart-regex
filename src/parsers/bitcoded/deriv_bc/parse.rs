//! Bit-coded POSIX parsers (derivBC): recursive, loop, and traced variants.

use crate::types::{Regex, ParseTree, ARegex};
use crate::regex::bitcoded::nullable::nullable_bc;
use crate::regex::bitcoded::deriv::deriv_bc;
use crate::regex::bitcoded::simplify::simp;
use super::internalize::internalize;
use super::mk_eps_bc::mk_eps_bc;
use crate::parsers::bitcoded::decode::decode;
